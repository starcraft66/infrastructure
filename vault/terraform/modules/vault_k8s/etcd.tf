...
resource "vault_pki_secret_backend_issuer" "etcd" {
  backend     = vault_pki_secret_backend_root_cert.etcd.backend
  issuer_ref  = vault_pki_secret_backend_root_cert.etcd.issuer_id
}

resource "vault_pki_secret_backend_config_issuers" "etcd" {
  backend                       = vault_mount.pki_etcd.path
  default                       = vault_pki_secret_backend_issuer.etcd.issuer_id
