...
ifdef::env-github[]
WARNING: It appears that you are reading this document on GitHub. I urge you to https://git.tdude.co/tristan/asfdasdf[click on this link] to read the same document on GitLab which has far superior README formatting and rendering capabilities.
endif::[]
