...
patroni_id=$(bao read --field=role_id auth/approle/role/$CLUSTER_NAME-node-patroni/role-id)

# Generate one secret_id per node
patroni_secret_1=$(bao write --field=secret_id -f auth/approle/role/$CLUSTER_NAME-node-patroni/secret-id)
patroni_secret_2=$(bao write --field=secret_id -f auth/approle/role/$CLUSTER_NAME-node-patroni/secret-id)
patroni_secret_3=$(bao write --field=secret_id -f auth/approle/role/$CLUSTER_NAME-node-patroni/secret-id)
...
patroni_id=$(bao read --field=role_id auth/approle/role/$CLUSTER_NAME-node-patroni/role-id)
patroni_secret=$(bao write --field=secret_id -f auth/approle/role/$CLUSTER_NAME-node-patroni/secret-id)
